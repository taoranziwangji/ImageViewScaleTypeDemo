 ...
 */
public class AllNoRuleViewMiddle1Activity extends BaseGeneralActivity {
    @Override
    public void initView() {
        setContentView(R.layout.activity_allnoruleviewmiddle1);
    }

    @Override
    public void init() {
        ((TextView)findViewById(R.id.tv_title)).setText("长方形图片，长方形view，view短边连图片长边但比图短，view长边连图短边但比图长");
