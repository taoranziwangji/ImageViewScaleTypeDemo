 ...
 */
public class AllNoRuleViewShortActivity extends BaseGeneralActivity {
    @Override
    public void initView() {
        setContentView(R.layout.activity_allnoruleviewshort);
    }

    @Override
    public void init() {
        ((TextView)findViewById(R.id.tv_title)).setText("长方形图片，长方形view，view长宽都比图片小");
