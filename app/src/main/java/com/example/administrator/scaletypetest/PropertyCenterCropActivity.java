 ...
 */
public class PropertyCenterCropActivity extends BaseGeneralActivity {
    @Override
    public void initView() {
        setContentView(R.layout.activity_propertycentercrop);
    }

    @Override
    public void init() {
        ((TextView)findViewById(R.id.tv_title)).setText("centerCrop");
