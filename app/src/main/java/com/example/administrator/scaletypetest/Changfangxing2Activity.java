 ...
 */
public class Changfangxing2Activity extends BaseGeneralActivity {
    @Override
    public void initView() {
        setContentView(R.layout.activity_changfangxing2);
    }

    @Override
    public void init() {
        ((TextView)findViewById(R.id.tv_title)).setText("长方形图片，方形view,view长宽都比图片小");
