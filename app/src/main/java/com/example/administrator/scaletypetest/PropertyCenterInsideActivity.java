 ...
 */
public class PropertyCenterInsideActivity extends BaseGeneralActivity {
    @Override
    public void initView() {
        setContentView(R.layout.activity_propertycenterinside);
    }

    @Override
    public void init() {
        ((TextView)findViewById(R.id.tv_title)).setText("centerInside");
